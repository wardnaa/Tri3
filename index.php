...
$tanggal = date('d-m-Y');
$insert = $bonstri->anon($ip,$tanggal);
// $msisdn = "0895412323368";
// 0895412323368
$imei = "868880043302499";

if(isset($_POST['submit'])) {
    $msisdn = $_POST['phone'];
    $phone = $bonstri->auth($sesi,$msisdn);
    if($bonstri->minta_otp($msisdn,$imei)) {
                        ...
                        <div class="login-form">
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="phone" name="phone" placeholder="Phone Number">
                                </div>
                                <br>
